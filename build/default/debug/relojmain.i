...
PSECT udata_bank0
    ...
    CONTADORMES_2: DS 1
    CANTIDADMES10_2:DS 1

    CONTADORMES_3: DS 1
    CANTIDADMES10_3:DS 1
    ...
    CANTIDADMES10_4: DS 1
    CANTIDADDIAS10_3: DS 1
...
RESET_HORAS_MIN:
    ...
    MOVF CONTADORMES, W
    CALL TABLA_DE_DIAS
    MOVWF VAL_DIAS_TABLA

    CLRF CONTADORDIAS
    CLRF CANTIDADDIAS10
    MOVF DIA_UNI, W
    ADDWF CONTADORDIAS, F
    EVALUARDIADECE:
    MOVF DIA_DECE, W
    ADDWF CONTADORDIAS, F

    INCF CANTIDADDIAS10
    MOVF CANTIDADDIAS10, W
    SUBLW 10
    BTFSS ((STATUS) and 07Fh), 2
    GOTO EVALUARDIADECE

    MOVF CONTADORDIAS, W
    SUBWF VAL_DIAS_TABLA
    BTFSC ((STATUS) and 07Fh), 2
    GOTO REINICIAR_DIAS
    REGRESO:
    RETURN
...
INT_TMR0:
    ...
    BCF PORTD, 2
    BCF PORTD, 3
    BTFSC BANDERAS_SET, 0
    GOTO DISPLAY1_DECENAS
    BTFSC BANDERAS_SET, 1
    GOTO DISPLAY1_UNIDADES
    BTFSC BANDERAS_SET, 2
    GOTO DISPLAY2_DECENAS
    BTFSC BANDERAS_SET, 3
    GOTO DISPLAY2_UNIDADES
...
DEC_SEGST3:
    ...
    MOVLW 10
    ADDWF SEGUNDOSTMR4, F
    CALL OBTENER_UNIDADESSEGT
...
MODIFICAR_HORA:
    ...
    BTFSS PORTB, 0
    GOTO INCREMENTO_HORA

    BTFSS PORTB, 1
    GOTO DECREMENTO_HORA
...
MODIFICAR_SEGST:
    ...
    BTFSS PORTB, 0
    GOTO INCREMENTO_SEGST

    BTFSS PORTB, 1
    GOTO DECREMENTO_SEGST
...
MODIFICAR_MINT:
    ...
    BTFSS PORTB, 0
    GOTO INCREMENTO_MINT

    BTFSS PORTB, 1
    GOTO DECREMENTO_MINT
...
CONFIG_ALARMA:
    ...
    CLRF DISPLAY
    MOVF HORAALARMA_UNI, W
    CALL TABLA
    MOVWF DISPLAY

    MOVF HORAALARMA_DECE, W
    CALL TABLA
    MOVWF DISPLAY+1

    MOVF MINALARMA_UNI, W
    CALL TABLA
    MOVWF DISPLAY+2

    MOVF MINALARMA_DECE, W
    CALL TABLA
    MOVWF DISPLAY+3
...
INC_DIA_2:
    ...
    SUBLW 10
    BTFSS ((STATUS) and 07Fh), 2
    GOTO EVALUARDIADECE2

    MOVF CONTADORDIAS, W
    SUBWF VAL_DIAS_TABLA
    BTFSC ((STATUS) and 07Fh), 2
    CALL REINICIAR_DIAS_2
    RETURN
...
DEC_DIA:
    ...
    CLRF CANTIDADMES10_4
    MOVF MES_UNI, W
    ADDWF CONTADORMES_4, F
    EVALUARMESDECE4:
    MOVF MES_DECE, W
    ADDWF CONTADORMES_4, F

    INCF CANTIDADMES10_4
    MOVF CANTIDADMES10_4, W
    SUBLW 10
    BTFSS ((STATUS) and 07Fh), 2
    GOTO EVALUARMESDECE4

    MOVF CONTADORMES_4, W
    CALL TABLA_DET_MES
    MOVWF VAL_MES2_TABLA

    CLRF CONTADORDIAS_3
    CLRF CANTIDADDIAS10_3
    MOVF DIA_UNI, W
    ADDWF CONTADORDIAS_3, F
    EVALUARDIADECE3:
    MOVF DIA_DECE, W
    ADDWF CONTADORDIAS_3, F

    INCF CANTIDADDIAS10_3
    MOVF CANTIDADDIAS10_3, W
    SUBLW 10
    BTFSS ((STATUS) and 07Fh), 2
    GOTO EVALUARDIADECE3

    MOVF VAL_MES2_TABLA, W
    BCF ((STATUS) and 07Fh), 2
    XORLW 1
    BTFSC ((STATUS) and 07Fh), 2
    CALL MES_ENERO
...
MES_ENERO:
    ...
    MOVF CONTADORDIAS_3, W
    MOVWF CONTADORDIAS_3
    MOVLW 10
    SUBWF CONTADORDIAS_3, F
    INCF DIA_DECE
    BTFSC STATUS, 0
...
DEC_MES:
    ...
    CLRF CANTIDADMES10_2
    MOVF MES_UNI, W
    ADDWF CONTADORMES_2, F
    EVALUARMESDECE3:
    MOVF MES_DECE, W
    ADDWF CONTADORMES_2, F

    INCF CANTIDADMES10_2
    MOVF CANTIDADMES10_2, W
    SUBLW 10
    BTFSS ((STATUS) and 07Fh), 2
    GOTO EVALUARMESDECE3


    DECF CONTADORMES_2, F
    MOVF CONTADORMES_2, W
    CALL TABLA_DE_MES
    MOVWF VAL_MES_TABLA

    MOVF VAL_MES_TABLA, W
    BCF ((STATUS) and 07Fh), 2
    XORLW 0
    BTFSC ((STATUS) and 07Fh), 2
    GOTO MES_12
...
INC_SEGST:
    ...
    MOVLW 10
    ADDWF SEGUNDOSTMR2, F
    CALL OBTENER_UNIDADESSEG
...
DEC_SEGST:
    ...
    MOVLW 10
    ADDWF SEGUNDOSTMR3, F
    CALL OBTENER_UNIDADESSEG2
